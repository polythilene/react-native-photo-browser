...
export default class PhotoBrowser extends React.Component {
  ...
  static propTypes = {
    ...
    /*
     * Set back button visibility, default false
     */
  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      displayTopBar: (typeof this.props.showHeader !== 'undefined') ? this.props.showHeader : true,
    };

    console.log('axx', this.props);
    console.log('hdr', this.props.showHeader);
